...
db.run(`CREATE TABLE IF NOT EXISTS products(id INTEGER AUTO INCREMENT PRIMARY KEY, name TEXT NOT NULL, description TEXT, category TEXT NOT NULL, sub_category TEXT, quantity INTEGER, rate REAL, image TEXT)`, (err) => (err) ? console.error(err.message): console.log("Create Successful for products"))
